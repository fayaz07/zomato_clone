...
class _SelectLocationManuallyState extends State<SelectLocationManually>
  ...
  static StreamController streamController =
      StreamController<List<PlacesModel>>();
  ...
  Animation animation;
  Duration animDuration = Duration(milliseconds: 2000);

  @override
  void initState() {
    animationController =
        AnimationController(vsync: this, duration: animDuration);
    animation = Tween(begin: -1.0, end: -0.2).animate(
        ...
        return SafeArea(
          child: Transform(
            transform: Matrix4.translationValues(
                0.0, _height * animation.value * -1, 0.0),
...
//      });
      ...
      SessionData.places.add(PlacesModel(main_text: "location $location",secondary_text: "secondarty: $location"));
      SessionData.places.add(PlacesModel(main_text: "location $location",secondary_text: "secondarty: $location"));
      SessionData.places.add(PlacesModel(main_text: "location $location",secondary_text: "secondarty: $location"));
